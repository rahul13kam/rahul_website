export const resumeData = {
  ...
  salesforceCertifications: [
    ...
    {
      name: "Sales Ranger: 50+ Badges",
      source: "Trailhead",
      link: "trailblazer/m6rywkp9t3p3a1q7yi"
    }
  ],
  skills: {
  ...
  experience: [
    {
      ...
      description: [
        "Developed and implemented Sales Cloud and Service Cloud solutions for an educational services company, supporting 500+ users.",
        "Designed custom Apex code, Visualforce pages, and Aura components to meet complex business requirements.",
        "Built and maintained integrations between Salesforce and external systems including Kona LMS using REST/SOAP APIs.",
        "Implemented automated business processes using Lightning Flows, Process Builder, and Workflow Rules.",
        "Developed Lightning Web Components with decorators, wiring services, and imperative Apex calls for enhanced UI functionality.",
        "Created complex Batch Apex, Scheduled Apex, and Queueable Apex for large-scale data processing.",
        "Configured comprehensive security model including OWD settings, profiles, permission sets, roles, and sharing rules.",
        "Built custom reports and dashboards for executive leadership providing real-time business insights.",
        "Implemented web-to-lead generation, email automation, and custom notifications for marketing campaigns.",
        "Worked with Agile methodologies using Azure and Trello for sprint planning and project tracking."
      ]
    },
    {
    ...
    },
    {
      ...
      description: [
        "Delivered 15+ full-stack projects using Angular, Spring Boot, NestJS, and MySQL for education technology platforms.",
        "Developed real-time student testing and evaluation tools with backend service integration supporting 100K+ submissions.",
        "Implemented SEO optimization and performance improvements on public platforms (scoreedge.net, srichaitanyameta.com).",
        "Built comprehensive unit testing strategies using Jest, Jasmine, and Karma to ensure code quality and reliability.",
        "Received Spot Award for exceptional performance in critical module deliveries and production issue resolution.",
        "Collaborated with cross-functional teams and mentored junior developers on development best practices."
      ]
    }
  ],
  projects: [
    ...
    },
    {
      ...
      description: "Developed comprehensive modules for live classes, test creation, and homework tracking supporting 100K+ submissions.",
      category: "Web Development"
    },
    {
      title: "ScoreEdge Enrollment Site",
      tech: "React.js, Material UI, SEO, Next.js",
      description: "Built region-wise test enrollment platform with server-side rendering and SEO optimization at scoreedge.net.",
      category: "Web Development",
      link: "scoreedge.net"
    },
    {
      title: "Knowledge Hub – Internal Portal",
      tech: "Angular, Spring Boot, MySQL",
      description: "Developed internal resource management system with secure authentication, role management, and content tracking.",
      category: "Web Development"
    },
    {
      title: "Student Reports System",
  ...
  certifications: [
    {
      name: "Frontend Development: HTML5, CSS3, JavaScript, React.js",
      institution: "Great Learning"
    },
    {
      name: "Backend Development: Spring Boot, Hibernate, JSP, Servlets",
      institution: "Great Learning"
    }
  ],
  languages: ["English: Professional Working Proficiency", "Hindi: Native Proficiency"]
};
