  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 max-w-6xl mx-auto">
          {/* Education Column */}
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-10 text-gray-800 border-l-8 border-blue-500 pl-4 sm:pl-6">Education</h2>
            <div className="space-y-5 sm:space-y-6 md:space-y-8">
              {resumeData.education.map((edu, index) => (
                <div key={index} className="bg-gray-50 p-5 sm:p-6 md:p-8 rounded-xl hover:bg-white hover:shadow-lg transition-all border border-transparent hover:border-gray-100">
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-10 text-gray-800 border-l-8 border-green-500 pl-4 sm:pl-6">Certifications</h2>
            <div className="space-y-5 sm:space-y-6 md:space-y-8">
